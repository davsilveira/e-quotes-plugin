 ...
 *
 * All JS utilities scripts should be attached to our namespace for easy access.
 *
 * @since 1.0.0
 */
...
const eQuotes = window.eQuotes || {

	/**
	 * Check if the resource exists and attach to the eQuotes object.
	 *
	 * @since 1.0.0
	...
	attach( name, resource = null, destroyOriginalProperty = true ) {
		...
		// Assign to the eQuotes instance.
		this[name] = resource || this.extend( name, destroyOriginalProperty );
	},

	/**
	 * Remove a resource (object, function, property) from eQuotes object.
	 *
	 * @since 1.0.0
	 *
